...
from service_kit.logging import logger as skit_logger


class Timer:
    """
    Just another timer utility that can be used as a context manager or a decorator.
